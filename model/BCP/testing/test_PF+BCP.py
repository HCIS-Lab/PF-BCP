...
def read_target_point():
    ...
    for _type in data_types:
        target_point_dict[_type] = json.load(open(f"./metadata/RiskBench/target_point_{_type}.json"))
        ...
        for sample in pbar:
            ...
            for frame_id in range(frame-args.time_step+1, frame+1):
                ...
                if actor_id != "all_actor":
                    gt_pf[0] = npy_file['all_actor']-actor_pf
                else:
                ...
                gt_pf = gt_pf.clip(0.1)*VIEW_MASK_CPU[None, ...]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', choices=["pf"], type=str, required=True)
